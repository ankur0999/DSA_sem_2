    ...
    while(z->parent->color == 1){
        ...
        if(z->parent == z->parent->parent->left){
            ...
            if(y->color == 1){
                ...
                z->parent->color = 0;
                z->parent->parent->color = 1;
                z = rightRotate(root, z->parent->parent);
            ...
            if(y->color == 1){
                ...
                z->parent->color = 0;
                z->parent->parent->color = 1;
                z = leftRotate(root, z->parent->parent);
            }
        }
        if(!z->parent)break;
...
Node* RBT:: leftRotate(Node*& root, Node* x){
    Node* y = x->right;
   x->right = y->left;
   if(y->left)
       y->left->parent = x;
...
Node* RBT:: rightRotate(Node*& root, Node* y){
    Node* x = y->left;
    y->left = x->right;
